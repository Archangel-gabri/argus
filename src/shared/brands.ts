...
// Порядок важен: более узкое написание должно стоять раньше общего, иначе «Yandex Cloud»
// опознается как «Yandex». Проверяется тестом.
const MATCHES: BrandMatch[] = [
  // Хостеры и облака
  { key: 'yandex-cloud', test: /yandex|яндекс/i },
