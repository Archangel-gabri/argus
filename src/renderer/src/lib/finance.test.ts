...
describe('итог по счетам', () => {
  ...
  it('остаток, полученный по ключу, не считается протухшим по дате ввода', () => {
    // У спрошенного по ключу остатка свежесть определяется опросом, а не тем, когда его завели.
