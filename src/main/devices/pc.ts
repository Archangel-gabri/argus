...
import { getOsEndpoints, getDeviceMac, type OsEndpoint } from '../vault/vault'
import { execOnConn, isConnAlive } from '../remote/ssh'
...
import { quoteForShell } from '../remote/shell-out'
import {
  BOOT_READY_MARKER,
