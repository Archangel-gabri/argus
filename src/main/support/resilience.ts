...
/**
 * Забыть все размыкатели.
 *
 * Сейчас зовётся только из проверок. Комментарий обещал вызов при блокировке хранилища — этого
 * не происходит: политика блокировки про размыкатели не знает. Обещание убрано, чтобы читающий
 * не рассчитывал на сброс, которого нет; если он нужен по существу — это отдельная правка
 * lockdown, а не строчка в комментарии.
 */
