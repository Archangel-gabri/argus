 ...
 * Разные валюты не сводятся здесь — если счета в разных валютах, возвращается только рублёвая
 * часть, а остальное честно остаётся за кадром: курс придумывать не наше дело.
 */
