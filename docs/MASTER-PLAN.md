...
> **АРХИВ — черновик видения от 2026-07-01.**
>
> Хранится ради истории продуктовых решений. Что уже неверно: имя «Nexus One» (приложение
> называется Argus), палитра cyan (действует Graphite & Ember), вкладка C5 Streaming (удалена),
> дерево `src/` (не совпадает с фактическим). Действующее описание — `docs/ENGINEERING-NOTES.md` проекта.
